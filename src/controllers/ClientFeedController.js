...
var ClientFeed_1 = require("../entity/ClientFeed");
var getAll = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var all;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ClientFeed_1.ClientFeed.find()];
            case 1:
                all = _a.sent();
                res.send(all);
                return [2 /*return*/];
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ClientFeed_1.ClientFeed.create({
            ...
            case 2:
                error_1 = _a.sent();
                res.send(errorResponse_1.errorHandler(error_1));
                return [3 /*break*/, 3];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientFeed, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ClientFeed_1.ClientFeed.findOne(req.params.id)];
            case 1:
                clientFeed = _a.sent();
                if (!clientFeed) {
            ...
            case 2:
                error_2 = _a.sent();
                res.send(errorResponse_1.errorHandler(error_2));
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var deleteFeed = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ClientFeed_1.ClientFeed["delete"](req.params.id)];
            case 1:
                _a.sent();
                res.send({
                    success: true,
