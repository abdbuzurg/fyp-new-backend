...
var updateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                return [4 /*yield*/, User_1.User.findOne(+req.params.id)];
            case 1:
                user = _b.sent();
                if (!user) {
            ...
            case 3:
                error_3 = _b.sent();
                res.send(errorResponse_1.errorHandler(error_3));
                return [3 /*break*/, 4];
...
var deleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, User_1.User["delete"]({ id: +req.params.id })];
            case 1:
                _a.sent();
                res.send({
                    success: true,
